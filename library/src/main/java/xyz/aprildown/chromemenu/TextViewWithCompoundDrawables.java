 ...
 */
class TextViewWithCompoundDrawables extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray array = context.obtainStyledAttributes(
                attrs, R.styleable.CmTextViewWithCompoundDrawables, defStyleAttr, 0);

        mDrawableWidth = array.getDimensionPixelSize(
                R.styleable.CmTextViewWithCompoundDrawables_cm_drawableWidth, -1);
        mDrawableHeight = array.getDimensionPixelSize(
                R.styleable.CmTextViewWithCompoundDrawables_cm_drawableHeight, -1);
        mDrawableTint = array.getColorStateList(
                R.styleable.CmTextViewWithCompoundDrawables_cm_chromeDrawableTint);
